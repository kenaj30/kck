...
plt.grid(linestyle = "--")
#plt.margins(x=0) #y nie na 0, zamiana na xlim - jeden z plikow ma wiecej danych
plt.title("Pokolenie")
plt.xlabel(r"Rozeganych gier $\times$ 1000", fontsize = 11) #czy o to chodziło z czcionką?
